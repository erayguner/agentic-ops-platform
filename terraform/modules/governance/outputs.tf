...
output "model_armor_template_id" {
  description = "Resource ID of the default AOP Model Armor template."
  value       = google_model_armor_template.aop_default.id
}

output "scc_notification_config_name" {
  description = "Resource name of the AOP SCC project notification config."
  value       = google_scc_project_notification_config.aop.name
}
